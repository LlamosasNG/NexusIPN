  ...
  if (data)
    return (
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <div className="bg-gradient-to-br from-[#7C2855] to-[#5a1d3f] rounded-3xl shadow-xl overflow-hidden">
            <div className="p-8 sm:p-12">
              <div className="text-center text-white">
                ...
                <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto">
                  Gestiona tus planificaciones didácticas y recursos digitales
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <div className="p-10">
                {/* Icono */}
                <div className="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#7C2855] to-[#5a1d3f] rounded-2xl mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
            ...
            >
              <div className="p-10">
                {/* Icono */}
                <div className="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#D4AF37] to-[#e8c96f] rounded-2xl mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
              ...
              {/* Elemento decorativo */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#7C2855]/10 to-transparent rounded-bl-full" />
            </Link>
          </div>
        </div>
